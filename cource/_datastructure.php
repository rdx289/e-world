  ...
  <!-- ======================End Header Image========================== -->
    <!-- ======================Course Title========================== -->
      <div class="course-title">
         ...
         <h6> <a href="../comp_program.php"> >>Programming</a> <a href="#">>>DATA STRUCTURE</a> </h6>
        ...
        <!-- ======================End Course Title========================== -->
         <!-- ======================Course Info========================== -->
    <div class="under">
	<img src="image/datast.png">
	<div class="duration">
	<b>Duration:-</b> 6 Months<br>
	<b>Level:-</b> Beginner
	
	</div>
	<h2>Data Structure</h2><hr>
	<b>Data Structure</b> is not a programming language. A good algorithm usually comes together with a set of good data structures that allow the algorithm to manipulate the data efficiently. In this course, we consider the common data structures that are used in various computational problems. You will learn how these data structures are implemented in different programming languages and will practice implementing them in our programming assignments.</p>
        <br>
	<b>About this Specialization</b><br>
     This specialization is a mix of theory and practice: you will learn algorithmic techniques for solving various computational problems and will implement about 100 algorithmic coding problems in a programming language of your choice. No other online course in Algorithms even comes close to offering you a wealth of programming challenges that you may face at your next job interview.</p>
