...
<!-- ======================Courese Segment=========================== -->
  ...
  <!-- ======================End Header Image========================== -->
    <!-- ======================Course Title========================== -->
      <div class="course-title">
         <h1>C++</h1>
         <h6> <a href="../comp_program.php"> >>Programming</a> <a href="#">>>C++</a> </h6>
 ...
 <!-- ======================Course Info========================== -->
	...
	<h2>Programming In C Plus Plus</h2><hr>
	<b> Overview of C</b>C++ is a general purpose programming language that supports various computer programming models such as object-oriented programming and generic programming. It was created by Bjarne Stroustrup and, “Its main purpose was to make writing good programs easier and more pleasant for the individual programmer.”* By learning C++, you can create applications that will run on a wide variety of hardware platforms such as personal computers running Windows, Linux, UNIX, and Mac OS X, as well as small form factor hardware such as IoT devices like the Raspberry PI and Arduino–based boards. (Bjarne Stroustrup, The C++ Programming Language, Third Edition. Reading, MA: Addison-Wesley, 1997). </p>
        
       
	<ul><b><u>What you'll learn?</u></b>
	<li> Build and execute a C program in C++</li>
       <li>Write equivalent programs in C++</li>
       <li>C++ as Better C </li>
       <li>Procedural Extensions of C</li>
       <li>Overview of OOP in C++</li>
       <li>Classes and basic Object-Oriented features (encapsulation)</li>
       <li>Overview of OOP in C++ </li>
       <li>More OOP features </li>
       <li>overloading </li>
       <li>namespace and using struct and union </li>
       <li>Inheritance</li>
       <li>Generalization / Specialization of Object Modeling in C++</li>
       <li>Polymorphism</li>
       <li>Static and Dynamic Binding</li>
       <li>Type Casting &amp; Exceptions</li>
       <li>C++ cast operators</li>
       <li>C++ Exceptions &amp; standard exception classes</li>
       <li>Templates &amp; STL – Function and Class templates and using STL like containers</li>
