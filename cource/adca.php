...
<ol class="under-about1">
		<li><a class="active" href="#">Computer Zone<i class="fas fa-caret-right"></i></a>
			...
			<li><a class="active" href="../comp_basic.php">Basic</a></li>
...
<!-- ======================Courese Segment=========================== -->
    ...
    <!-- ======================Header Image========================== -->
      <div class="course-image">
        <h1> Basic Computer <span>Zone</span> </h1>
      </div>
  <!-- ======================End Header Image========================== -->
    <!-- ======================Course Title========================== -->
      <div class="course-title">
         <h1>ADCA : Advance Diploma in Computer Application</h1>
         <h6> <a href="../comp_basic.php"> >>Basic</a> <a href="#">>>ADCA</a> </h6>
        ...
        <!-- ======================End Course Title========================== -->
                   <!-- ======================Course Info========================== -->
    <div class="under">
	<img src="image/adca.jpg">
	<div class="duration">
	<b>Duration:-</b> 6 Months<br>
	<b>Level:-</b> Beginner
	
	</div>
	<h2>Advance Diploma in Computer Application</h2><hr>
	 Advance Diploma in Computer Applications acronym is ADCA. The persons who are good at maths and interested in computer technology can go on to Diploma in Computer Application. This course gives the advance knowledge of computer applications. There is demand for skilled person for handling Computer Applications. </p>
      <br>
	The ADCA offered at The Global Open University Nagaland is having the latest curriculum related to IT Applications syllabus at the advanced Diploma level with the view to preparing software professionals for catering to the IT and the Software Industry in all developed countries of the world. The curriculum and the study materials are revised and updated every six months for the inclusion of the latest trends in computer industry. Accordingly assistance and advice are sought on a continuing basis from the industry for knowing and assessing their requirements.</p>
		  <br>
           
	<ul><b><u>What you'll learn?</u></b>
	 <li> Work-Sheets </li>
<li>Docs-Word</li>
