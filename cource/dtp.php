  ...
  <!-- ======================End Header Image========================== -->
    <!-- ======================Course Title========================== -->
      <div class="course-title">
         <h1>DTP :Desktop Publication</h1>
         <h6> <a href="../comp_basic.php"> >>Basic</a> <a href="#">>>DTP</a> </h6>
        ...
        <!-- ======================End Course Title========================== -->
                     <!-- ======================Course Info========================== -->
    <div class="under">
	<img src="image/dtp.jpg">
	<div class="duration">
	<b>Duration:-</b> 6 Months<br>
	<b>Level:-</b> Beginner
	
	</div>
	<h2>DTP :Desktop Publication</h2><hr>
	The D T P Program is focusing on the various designing techniques and effects for the printing industry.
	Candidates who complete this course can start their own designing firm catering to project works such as Brochure Designing, Visiting Cards, Banners, Flyers, Magazines and Newsletters etc. 
	Individuals also has an option to appear for Government recognized examination. 
	<br><br>
