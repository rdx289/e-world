  ...
  <!-- ======================End Header Image========================== -->
    <!-- ======================Course Title========================== -->
      <div class="course-title">
         <h1>SAP</h1>
         <h6> <a href="../comp_program.php"> >>Programming</a> <a href="#">>>Sap</a> </h6>
        ...
        <!-- ======================End Course Title========================== -->
          <!-- ======================Course Info========================== -->
    <div class="under">
	<img src="image/sap.png">
	<div class="duration">
	<b>Duration:-</b> 6 Months<br>
	<b>Level:-</b> Beginner
	
	</div>
	<h2>SAP: systems applications and products</h2><hr>
	 <br>
...
<ul><b><u>What you'll learn?</u></b>
	<li>Data warehouses</li>
       <li>Business processes and scenarios</li>
       <li>Commodity management</li>
       <li>Billing</li>
       <li>Master data</li>
       <li>Inventory and delivery processes</li>
