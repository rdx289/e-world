  ...
  <!-- ======================End Header Image========================== -->
    <!-- ======================Course Title========================== -->
      <div class="course-title">
         <h1>JAVA</h1>
         <h6> <a href="../comp_program.php"> >>Programming</a> <a href="#">>>JAVA</a> </h6>
	...
	<h2>JAVA</h2><hr>
	 ...
	 This striking feature received a lot of attention and soon java became one of the sought after programming languages that could be used for small and medium sized software development purposes. As the time advanced, 
	 java grew from being a platform-friendly language to user-friendly programming as well.
	 <br><br>

	<ul><b><u>Classification of Java</u></b>
	<li>Client side Java development</li>
       <li>Server side Java development</li>
       <li>Web Development</li>
       <li>Mobile Development</li>
       <li>Machine learning through Java</li>
