...
<ol class="under-about1">
		...
		<li><a class="no_active" href="#">Science<i class="fas fa-caret-right"></i></a>
		<ol class="under_comscience1">
			<li><a href="junior.php">Junior(6,7,8,9,10)</a></li>
			<li><a class="no_active" href="intermediate_science.php">Intermediate</a></li>
			<li><a class="no_active" href="iitjee.php">IIT-JEE</a></li>
		...
		<li><a class="active" href="#">Competition<i class="fas fa-caret-right"></i></a>
		<ol class="under_comscience3">
			<li><a class="no_active" href="ssc.php">SSC</a></li>
			<li><a class="no_active" href="banking.php">Banking</a></li>
			<li><a class="active" href="railway.php">Railway</a></li>
			</ol>
		</li>
		</ol>
</li>
  ...
  <!-- ======================End Header Image========================== -->
    <!-- ======================Course Title========================== -->
      <div class="course-title">
        ...
        <!-- ======================Course Info========================== -->
    <div class="under">
	<img src="image/rrb.jpg">
	<div class="duration">
	<b>Duration:-</b> 6 Months<br>
	<b>Level:-</b> Beginner
	
	</div>
	<h2>Railway Recruitment Board</h2><hr>
	Railway Competitive Examinations In India Indian Railways is the second largest railway system in the world. 
	Its employees are numbered at about 16 lakhs. Indian Railways is divided into 16 zones and each zone is headed by a General Manager.
	Every zone is divided into some divisions and each division is headed by a Divisional Railway Manager. 
	The posts in railways are divided into four groups. They are:<br><br>
	<ul>
	<li>Group A</li>
	<li>Group B</li>
	<li>Group C</li>
