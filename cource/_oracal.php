...
<head>
  ...
  <link rel="stylesheet" href="coursee.css">
...
<ol class="under-about1">
		<li><a class="active" href="#">Computer Zone<i class="fas fa-caret-right"></i></a>
			...
			<li><a class="active" href="../comp_program.php">Programming</a></li>
			
			</ol>
		</li>
		<li><a href="#">Science<i class="fas fa-caret-right"></i></a>
		<ol class="under_comscience1">
			<li><a href="junior.php">Junior(6,7,8,9,10)</a></li>
			<li><a href="intermediate_science.php">Intermediate</a></li>
			<li><a href="iitjee.php">IIT-JEE</a></li>
			<li><a href="medical.php">Medical</a></li>
			<li><a href="science_hons.php">Honours</a></li>
			</ol>
		</li>
		<li><a href="#">Commerce<i class="fas fa-caret-right"></i></a>
		<ol class="under_comscience2">
			<li><a href="intermediate_com.php">Intermediate</a></li>
			<li><a href="commerce_hons.php">Honours</a></li>
			</ol>
		</li>
...
<!-- ======================Courese Segment=========================== -->
    ...
    <!-- ======================Header Image========================== -->
      <div class="course-image">
        <h1>Programming <span>Zone</span> </h1>
      </div>
  <!-- ======================End Header Image========================== -->
    <!-- ======================Course Title========================== -->
      <div class="course-title">
         <h1>Oracal</h1>
         <h6> <a href="../comp_program.php"> >>Programming</a> <a href="#">>>ORACAL</a> </h6>
    ...
    Database administrators use Oracle, a widely used database management system, to store and manage data for organizations and businesses.
	Those seeking online Oracle training are in luck, since many universities and colleges offer such options.
	<br><br>
	Most Oracle programs allow students to take classes individually or as part of a larger Oracle certificate program, and classes are generally graded based on completed lessons. Schools may offer online certificate programs that lead to college credit, 
	which are often available to those who already have bachelor's degrees.
<br><br>
Continuing education certificate programs may not have as strict admission requirements or award college credit, 
but they could prepare students for professional certification and are designed for IT professionals.
 An online certificate program is usually designed to be completed in under a year.       
	<br><ul><b><u>What you'll learn?</u></b>
	<li>Relational database concepts and entity relationship model</li>
       <li>Use Oracle-supplied SQL functions</li>
       <li>Format SQL</li>
       <li>Plus reports</li>
       <li>Use SQL with sub-queries and joins in a multi-table environment</li>
       <li>Use SQL99 joint syntax</li>
       <li>Control user access</li>
       <li>Maintain data integrity with constraints</li>
       <li>Retrieve, insert, update and delete data</li>
