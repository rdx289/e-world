  ...
  <!-- ======================End Header Image========================== -->
    <!-- ======================Course Title========================== -->
      <div class="course-title">
         <h1>TALLY</h1>
         <h6> <a href="../comp_basic.php"> >>Basic</a> <a href="#">>>Tally</a> </h6>
	...
	<h2>Tally</h2><hr>
	 <br>
During Tally computer course student learns advanced functionality Tally ERP, which is in great demand in india. 
During Tally Course focus remains on practical aspects of Tally Training, with the help of experienced and Tally Certified Trainers at IPA Tally Learning Institute in Delhi. Tally ERP is enterprise resource planning software widely used in India and oversaes. It performs all those functions that are required for a business related to Accounting, inventory,
 Billing, Income Tax, TDS, GST and payroll	 
 <br>
 <br>
